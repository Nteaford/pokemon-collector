...
path('pokemon/<int:pokemon_id>/remove_badge/<int:badge_id>/', views.remove_badge, name='remove_badge'),


path('pokemon/<int:pokemon_id>/assoc_hiddenmachine/<int:hiddenmachine_id>/', views.assoc_hiddenmachine, name='assoc_hiddenmachine'),
